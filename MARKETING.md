...
![Motion Preview app icon](images/motion_preview_app_icon.png)
...
资源仅在本机读取和解码，不会上传到网络。Motion Preview 适合设计师、动效工程师和客户端开发者快速检查交付资源。详情请参阅[隐私政策](PRIVACY.md)。

![Motion Preview Lottie preview](metadata/app_store/screenshots/en-US/motion-preview-lottie-1280x800.png)
...
Resources are read and decoded locally and are not uploaded. Motion Preview gives designers, motion engineers, and client developers a direct way to inspect delivered assets. See the [Privacy Policy](PRIVACY.md) for details.
